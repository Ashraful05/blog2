        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                @else
                    <div class="card my-4">
                        <div class="card-body">
                            <h5 class="card-title">You have to login to comment.If you have registered earlier then <a
                                    href="{{route('visitor-login')}}">LogIn</a> or <a href="{{route('sign-up')}}">SignUp</a> </h5>
                        </div>
                    </div>
            @endif
